    ...
    local commands = {
        ...
        ["unit"] = {
            ...
            fn = function(options)
                ...
                Print(TEXT_WAAAGH_NAME ..
                (UnitName(target) or "") ..
                TEXT_WAAAGH_CLASS ..
                (UnitClass(target) or "") .. TEXT_WAAAGH_CLASSIFICATION .. (UnitClassification(target) or ""))
...
function Waaagh_OnEvent()
    ...
    if event == "CHAT_MSG_COMBAT_SELF_MISSES"
        ...
        SendChatMessage("Interrupt FAILED on [ %t ]", "SAY", nil)
        WaaaghSpellInterrupt = nil
    end
    if (event == "CHAT_MSG_SPELL_SELF_DAMAGE"
