# Waaagh
Waaagh Addon originally by Bhaerau, modifications/expanded by cubenicke. Purpose for the addon is to make a Warriors life easier while raiding/Farming in vanilla wow.
Waaagh makes one button for the Warrior rotation, but still makes it possible to adapt the rotation with manual settings to make it adapt for each fight. Also gives some aid with mid-fight buffs
...
### KeyBinds
Attack - One button Waaagh Warrior rotation. Spam it!  
...
Toggle DW - Enable it a bit into fights when you want your first Death Wish to fire off (Also controls Orc racial Blood Waaagh).  
...
![](https://classicdb.ch/images/icons/small/racial_orc_berserkerstrength.jpg) [Blood Waaagh](https://classicdb.ch/?spell=20572)  
